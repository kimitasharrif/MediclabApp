...
import com.sherrif.mediclab.databinding.ActivityMemberProfileBinding
...
class MemberProfile : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        val appBarConfiguration = AppBarConfiguration(
            setOf(
                R.id.navigation_home, R.id.navigation_dependants, R.id.navigation_dashboard, R.id.navigation_notifications
            )
        )
